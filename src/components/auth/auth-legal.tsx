...
export function AuthIllustration() {
  return (
    <div className="authIllustration mx-auto mt-2.5 h-[4.5rem] w-full max-w-[20rem] shrink-0 overflow-hidden lg:h-20 lg:max-w-[22rem] min-[1800px]:h-24 min-[1800px]:max-w-[24rem]">
