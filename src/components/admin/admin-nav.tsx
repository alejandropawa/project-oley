      ...
      {adminLinks.map((link) => {
        ...
        return (
          <Link
            key={link.href}
            href={link.href}
            className="inline-flex h-10 shrink-0 items-center gap-2 rounded-full px-4 text-sm font-bold text-muted-foreground transition hover:bg-muted hover:text-primary"
          >
